...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <a href="{{ route('user.kategori.index') }}" class="btn btn-sm btn-primary mt-2">List Kategori</a>
    <div class="mt-4">
      <ul>
        ...
        <hr>
        <li>
          NB : Foto / Vidio tidak akan muncul di halaman utama kecuali sudah di Acc Admin
        </li>
      </ul>
    </div>
  </div>
      ...
      <table class="table table-bordered table-strip" id="listBerita" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('user.galeri.edit', $galeri->slug) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
              <form id="deleteData" action="{{ route('user.galeri.destroy', $galeri->slug) }}" method="post" class="d-inline">
                @method('delete')
                @csrf
