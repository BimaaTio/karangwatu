          ...
          <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <div class="flex items-center">
                ...
                <a href="#" class="ml-1 text-sm font-medium text-amber-700 hover:text-amber-600 md:ml-2 dark:text-amber-400 dark:hover:text-white">Kategori</a>
              </div>
            </li>
          </ol>
        </nav>
        @foreach($kategori as $k)
        <div class="w-full max-w my-4 bg-white border items-center justify-center border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div class="px-5 py-5">
            <a href="/berita/kategori/{{ $k->slug }}">
              <h5 class="text-xl font-semibold text-center hover:underline tracking-tight text-gray-900 dark:text-white">{{ $k->nama }}</h5>
            </a>
          </div>
        </div>
        @endforeach
