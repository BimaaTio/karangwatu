...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    ...
    <a href="/dashboard/admin/news" class="btn btn-sm btn-success my-1">Kembali</a>
  </div>
  <div class="card-body">
    <form action="/dashboard/admin/news/{{ $data->id }}" method="post" enctype="multipart/form-data">
      @method('PUT')
      @csrf
