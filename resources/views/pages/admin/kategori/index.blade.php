        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
              <a href="{{ route('kategori.edit', $k->slug) }}" class="btn btn-sm btn-warning"><i class="fas fa-edit"></i></a>
              <form id="deleteData" action="{{ route('kategori.destroy', $k->slug) }}" method="post" class="d-inline">
                @method('delete')
                @csrf
